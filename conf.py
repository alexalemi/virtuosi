...
BLOG_AUTHOR = "The Virtuosi"  # (translatable)
...
BLOG_EMAIL = "thephysicsvirtuosi@gmail.com"
BLOG_DESCRIPTION = "Things and Stuff."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "thephysicsvirtuosi"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-15719155-6"></script>
<script>
