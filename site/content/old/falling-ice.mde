...
and y (vertical) components of velocity, $$v\_x=|v|\\cos\\theta$$
$$v\_y=-|v|\\sin \\theta$$ where I've introduced a minus sign in the y
...
traveled by an object with an initial velocity, v\_0, and a constant
acceleration, a, is given by $$\\Delta y=\\tfrac{1}{2}at\^2+v\_0t$$ In
...
into components we get $$a\_x=-\\frac{bv}{m}v\_x$$
$$a\_y=-g-\\frac{bv}{m}v\_y$$ This is as far as we can take this work
