...
then the fluence (or time integrated energy flux) is given by $$ F\_{ph}
= \\frac{E\_{ph}}{4\\pi d\^2}. $$ All this is saying is that the total
...
The total energy deposited on Earth is then $$ E\_{\\oplus} = F\_{ph}
\\times \\pi R\^2\_{\\oplus}. $$ Hot dog! Let's plug in some numbers,
...
10\^16 m) is $$E\_{\\oplus}=\\frac{E\_{ph}}{4\\pi d\^2}\\times\\pi
R\^2\_{\\oplus}\\sim
10\^{19}\~\\mbox{J}\\left(\\frac{E\_{ph}}{10\^{44}\~\\mbox{J}}\\right)\\left(\\frac{d}{200\~\\mbox{pc}}\\right)\^{-2}.$$
...
m\_{atm}c\_{air}\\Delta T $$ where c is the specific heat of air
...
have $$ P = F/A = m\_{atm}g / A\_{\\oplus} $$ So $$ m\_{atm} =
\\frac{P\\times4\\pi
R\^2\_{\\oplus}}{g}=\\frac{10\^5\~\\mbox{Pa}\\times4\\pi
...
\\frac{E\_{ph}}{m\_{atm}c\_{air}}=\\frac{10\^{19}\~\\mbox{J}}{4\\times10\^{18}\~\\mbox{kg}\\times10\^3\~\\mbox{J/
...
[gamma-ray burst](http://en.wikipedia.org/wiki/Gamma-ray_burst) (GRBs to
...
GRBs can be seen at much greater distances than a typical supernova.
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [![image](http://2.bp.blogspot.com/-siXXiFnQWHY/TrITJA8z_sI/AAAAAAAAAPU/qStD4_9qLBI/s320/grb.jpg)](http://2.bp.blogspot.com/-siXXiFnQWHY/TrITJA8z_sI/AAAAAAAAAPU/qStD4_9qLBI/s1600/grb.jpg)
